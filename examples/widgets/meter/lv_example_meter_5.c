...
static void pie_meter_builder(struct meter_item * meter_in)
{
    ...
    lv_meter_indicator_t * indic1 = lv_meter_add_arc(meter, indic_w,
                                                     lv_palette_main(LV_PALETTE_ORANGE), 0);
    lv_meter_set_indicator_start_value(meter, indic1, 0);
    lv_meter_set_indicator_end_value(meter, indic1, 40);

    lv_meter_indicator_t * indic2 = lv_meter_add_arc(meter, indic_w,
    ...
    lv_meter_indicator_t * indic3 = lv_meter_add_arc(meter, indic_w,
...
static void clock_meter_builder(struct meter_item * meter)
{
    ...
    lv_meter_set_scale_ticks(meter->obj, 60, 1, 10, lv_palette_main(LV_PALETTE_GREY));
    lv_meter_set_scale_major_ticks(meter->obj, 5, 2, 20, lv_color_black(), 10);
    lv_meter_set_scale_range(meter->obj, 0, 59, 354, 270);

    LV_IMG_DECLARE(img_hand)

    /*Add a the hands from images*/
    lv_meter_indicator_t * indic_min = lv_meter_add_needle_img(meter->obj,
                                                               &img_hand, 5, 5);
    lv_meter_indicator_t * indic_hour = lv_meter_add_needle_img(meter->obj,
                                                                &img_hand, 5, 5);
    ...
    lv_anim_set_values(&meter->a, 0, 59);
    lv_anim_set_repeat_count(&meter->a, LV_ANIM_REPEAT_INFINITE);
    lv_anim_set_time(&meter->a, 5000);     /*2 sec for 1 turn of the minute hand (1 hour)*/
...
static void multiarcs_meter_builder(struct meter_item * meter)
{
    ...
    /*Add a scale first*/
    lv_meter_set_scale_ticks(meter->obj, 11, 2, 10, lv_palette_main(LV_PALETTE_GREY));
    lv_meter_set_scale_major_ticks(meter->obj, 1, 2, 30, lv_color_hex3(0xeee), 15);
    lv_meter_set_scale_range(meter->obj, 0, 100, 270, 90);
    ...
    /*Add a three arc indicator*/
    lv_meter_indicator_t * indic1 = lv_meter_add_arc(meter->obj, 10,
                                                     lv_palette_main(LV_PALETTE_RED), 0);
    lv_meter_indicator_t * indic2 = lv_meter_add_arc(meter->obj, 10,
                                                     lv_palette_main(LV_PALETTE_GREEN), -10);
    lv_meter_indicator_t * indic3 = lv_meter_add_arc(meter->obj, 10,
...
{
    /*Add a scale first*/
    lv_meter_set_scale_ticks(meter->obj, 41, 2, 10, lv_palette_main(LV_PALETTE_GREY));
    lv_meter_set_scale_major_ticks(meter->obj, 8, 4, 15, lv_color_black(), 12);
    ...
    lv_meter_set_needle_side(meter->obj, meter->toggle_needle_side);

    lv_meter_indicator_t * indic;

    /*Add a blue arc to the start*/
    indic = lv_meter_add_arc(meter->obj, 5, lv_palette_main(LV_PALETTE_BLUE), 0);
    lv_meter_set_indicator_start_value(meter->obj, indic, 0);
    lv_meter_set_indicator_end_value(meter->obj, indic, 20);

    /*Make the tick lines blue at the start of the scale*/
    indic = lv_meter_add_scale_lines(meter->obj, lv_palette_main(LV_PALETTE_BLUE),
    ...
    indic = lv_meter_add_arc(meter->obj, 5, lv_palette_main(LV_PALETTE_RED), 0);
    lv_meter_set_indicator_start_value(meter->obj, indic, 80);
    lv_meter_set_indicator_end_value(meter->obj, indic, 100);

    /*Make the tick lines red at the end of the scale*/
    indic = lv_meter_add_scale_lines(meter->obj, lv_palette_main(LV_PALETTE_RED),
    ...
    indic = lv_meter_add_needle_line(meter->obj, 4, lv_palette_main(LV_PALETTE_GREY), 0);
